...
_C.MODEL.H2T = CfgNode()
_C.MODEL.H2T.NUM_QUERY_TOKENS = 5
_C.MODEL.H2T.DROPOUT = 0.0
_C.MODEL.H2T.NORMALIZE_FEATS = True
_C.MODEL.H2T.POOLING_FEATS = False
_C.MODEL.H2T.WEIGHTED_SUM_FEATS = False
_C.MODEL.H2T.LRP_COEF = 0.0001
_C.MODEL.H2T.KEEP_FRAC = 1.0
